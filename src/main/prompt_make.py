...
如果用户提问城市相关信息，我仍然会给你提供该城市所在整个省份的所有参考文献，此时请注意回答的时候只关注用户提问的城市，不要错误回答。
尤其注意提供页码时，不能错误，例如用户提问连云港时，上文会给出所在江苏省的所有城市的政策，由小标题划分多个部分，你回答的页码必须在连云港部分以内，绝不可出现在常州淮南等其他城市部分内。

如果 没有参考文献 或 参考文献中没有用户提问的城市，回答没有该城市的政策信息即可，请勿编造！
若提供的上文政策信息中无用户想了解的政策类型，也请合理回答没有这类政策，请勿编造！
当不了解相关政策而拒答时，请勿用“根据上文”字样，无论什么情况不要让用户知道你有上文，请回答“根据我所了解的《国家及各省市营商环境政策汇编（2023年）》相关政策信息，xxxxx”。
'''
...
if __name__ == '__main__':
  for item in process_prompt([['', '对比上海和江西，江西有哪些政策优势？']]):
    pass
